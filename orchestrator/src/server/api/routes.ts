...
import { companyResearchRouter } from "./routes/company-research";
...
import { profileExpandRouter } from "./routes/profile-expand";
import { resumeTemplatesRouter } from "./routes/resume-templates";
...
apiRouter.use("/profile-expand", profileExpandRouter);
apiRouter.use("/resume-templates", resumeTemplatesRouter);
apiRouter.use("/upskill", upskillRouter);
apiRouter.use("/salary", salaryRouter);
apiRouter.use("/company-research", companyResearchRouter);
