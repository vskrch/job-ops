...
export const createJob = (overrides: Partial<Job> = {}): Job => {
  const base: Job = {
    ...
    tailoredSkills: null,
    tailoredExperienceBullets: null,
  ...
  return {
    ...base,
    ...overrides,
    // Normalize scoreBreakdown: callers may pass `undefined` via Partial spread, but the domain type is null.
    scoreBreakdown:
      (
        overrides as unknown as {
          scoreBreakdown?: Job["scoreBreakdown"] | undefined;
        }
      ).scoreBreakdown ?? null,
  };
};
...
export const createAppSettings = (
  ...
  jobSearchMaxActiveSearches: { value: 4, default: 4, override: null },
  jobSearchSourceConcurrency: { value: 3, default: 3, override: null },
  jobSearchRankingConcurrency: { value: 4, default: 4, override: null },
  jobSearchMaxCandidates: { value: 500, default: 500, override: null },
  ...
  pipelineMaxConcurrentRuns: { value: 3, default: 3, override: null },
